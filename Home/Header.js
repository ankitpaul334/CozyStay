...
import { Logout } from "../../Store/User/user-action"; // Corrected import
...
const Header = () => {
  ...
  const logoutUser = () => { // Changed the function name to avoid conflict with imported Logout
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <li>
                <button
                  ...
                  type="button"
                  onClick={logoutUser} // Changed to call the updated logout function
                >
                  Logout
                </button>
              </li>
